                ...
                <div className="row justify-content-center">
                    <div className="col-12 col-md-12 col-lg-9">
                        <div className="forbidden__panel p-3 p-md-5 bg-white text-center">
                            ...
                            <h4 className="forbidden__subheader fw-bold pb-3">Page Not Found!</h4>
                            <p className="forbidden__text pb-5 fw-bold mb-0">We are sorry! but the page you requested cannot be found.</p>
